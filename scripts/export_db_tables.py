...
python export_db_tables.py ... --tables staff jobs --format csv --outdir ./exports

# Export ALL tables to CSVs
python export_db_tables.py ... --all --format csv --outdir ./exports
...
def main():
    ...
    # DB - use environment variables by default
    ap.add_argument("--db-name", default=os.environ.get('PGDATABASE'))
    ap.add_argument("--db-user", default=os.environ.get('PGUSER'))
    ap.add_argument("--db-password", default=os.environ.get('PGPASSWORD'))
    ap.add_argument("--db-host", default=os.environ.get('PGHOST'))
    ap.add_argument("--db-port", default=os.environ.get('PGPORT', '5432'))

    # Discovery/selection
    ap.add_argument("--schema", default="public", help="Schema to use (default: public)")
    ...
    ap.add_argument("--all", action="store_true", help="Export all tables in --schema")
    ap.add_argument("--tables", nargs="*", default=[], help="Explicit tables like staff jobs")
